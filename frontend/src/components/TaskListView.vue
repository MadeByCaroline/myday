  ...
  <div class="space-y-4">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-5">
      <div class="flex items-center gap-3 mb-4">
        ...
        <h3 class="text-base font-semibold text-gray-900">Suggested Tasks</h3>
        <span
      ...
      <TransitionGroup name="task-list" tag="div" class="space-y-3">
        ...
        >
          ...
          <div class="flex gap-2">
            ...
            >
              <i class="pi pi-times mr-1"></i>Refuse
            </button>
          </div>
        </div>
      </TransitionGroup>
    ...
    <div v-if="tasksStore.savedTasks.length > 0" class="bg-white rounded-2xl border border-gray-200 p-5">
      <div class="flex items-center gap-3 mb-4">
        ...
        <h3 class="text-base font-semibold text-gray-900">Accepted Tasks</h3>
      </div>
      <div class="space-y-2">
        <div
